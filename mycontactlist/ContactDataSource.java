...
public class ContactDataSource {
    ...
    public boolean insertContact(Contact c) {
        ...
        try {
            ...
            initialValues.put("bestfriendforever", c.getBff());
    ...
    public boolean updateContact(Contact c) {
        ...
        try {
            ...
            updateValues.put("bestfriendforever", c.getBff());
    ...
    public boolean updateContactAddress(ContactAddress c) {

        boolean didSucceed = false;
        //String didSucceedString = "false";
        try {
            open();
            Long rowId = (long) c.getContactID();
            ContentValues updateValues = new ContentValues();
    ...
    public boolean deleteContact(int contactId) {
        ...
        try {
            didDelete = database.delete("contact",
                    "_id=" + contactId, null) > 0;
        }
        catch (Exception e) {
